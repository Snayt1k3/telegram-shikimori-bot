...
edit_btn = InlineKeyboardButton("⚙️ Edit", callback_data="anime_watch.edit")
...
back_btn = InlineKeyboardButton("🔙", callback_data="anime_watch_one.back")
...
next_1 = InlineKeyboardButton('▶️', callback_data='anime_planned.next_1')
